...
implements VideoFragment.VideoFragmentListener,
                ...
                ActionCallback<Publication> callback = new ActionCallback<Publication>() {
                    ...
                    public void onFailure(final OwtError error) {
                        runOnUiThread(() -> {
                            ...
                            Toast.makeText(ConfActivity.this,
            ...
            executor.execute(() -> {
                ...
                conferenceClient.join(token, new ActionCallback<ConferenceInfo>() {
                    ...
                    public void onSuccess(ConferenceInfo conferenceInfo) {
                        ...
                        ConfActivity.this.conferenceInfo = conferenceInfo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(getApplication().getResources().getIdentifier("conf_activity", "layout", package_name));


        fullScreen = true;
        //bottomView = findViewById(R.id.bottom_bar);
        bottomView = findViewById(getResources().getIdentifier("bottom_bar","id", getPackageName()));
        //fragmentContainer = findViewById(R.id.fragment_container);
        fragmentContainer = findViewById(getResources().getIdentifier("fragment_container","id", getPackageName()));
        //leftBtn = findViewById(R.id.multi_func_btn_left);
        leftBtn = findViewById(getResources().getIdentifier("multi_func_btn_left","id", getPackageName()));
        leftBtn.setOnClickListener(joinRoom);
        //rightBtn = findViewById(R.id.multi_func_btn_right);
        rightBtn = findViewById(getResources().getIdentifier("multi_func_btn_right","id", getPackageName()));
        rightBtn.setOnClickListener(settings);
        //subscribeBtn = findViewById(R.id.multi_func_btn_subscribe);
        subscribeBtn = findViewById(getResources().getIdentifier("multi_func_btn_subscribe","id", getPackageName()));
        subscribeBtn.setOnClickListener(subscribe);
        subscribeBtn.setVisibility(View.GONE);
        //unSubscribeBtn = findViewById(R.id.multi_func_btn_unsubscribe);
        unSubscribeBtn = findViewById(getResources().getIdentifier("multi_func_btn_unsubscribe","id", getPackageName()));
        unSubscribeBtn.setOnClickListener(unSubscribe);
        unSubscribeBtn.setVisibility(View.GONE);
        //middleBtn = findViewById(R.id.multi_func_btn_middle);
        middleBtn = findViewById(getResources().getIdentifier("multi_func_btn_middle","id", getPackageName()));
    ...
    private void requestPermission() {
        ...
        for (String permission : permissions) {
            ...
            if (ContextCompat.checkSelfPermission(ConfActivity.this,
                    permission) != PERMISSION_GRANTED) {
                //ActivityCompat.requestPermissions(MainActivity.this,
                ActivityCompat.requestPermissions(ConfActivity.this,
                        permissions,
                        OWT_REQUEST_CODE);
                return;
            }
    ...
    private void onConnectSucceed() {
        runOnUiThread(() -> {
            ...
            videoFragment.setListener(ConfActivity.this);
            switchFragment(videoFragment);
            leftBtn.setEnabled(true);
            leftBtn.setTextColor(Color.WHITE);
            //leftBtn.setText(R.string.disconnect);
            leftBtn.setText("disconnect");
    ...
    private void switchFragment(Fragment fragment) {
        getSupportFragmentManager().beginTransaction()
                ...
                .replace(getResources().getIdentifier("fragment_container","id", getPackageName()), fragment)
        ...
        conferenceClient.subscribe(remoteStream, options,
                new ActionCallback<Subscription>() {
                    ...
                    public void onSuccess(Subscription result) {
                        ...
                        ConfActivity.this.subscription = result;
                        //MainActivity.this.remoteForwardStream = remoteStream;
                        ConfActivity.this.remoteForwardStream = remoteStream;
